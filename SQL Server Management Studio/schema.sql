---  PRODUCTS(Товары)
---ID_производителя,ID_товара,описание,цена,наличие товара на складе
...
---
---  OFFICES(Офисы)
---номер офиса,город,регион,ID_менеджера,план продаж,обьем продаж офиса
...
---
---  SALESREPS(Продавцы)
---номер сотрудника,имя,возраст,номер офиса,должность,дата найма,ID_руководителя,план продаж,обьем продаж
...
---
---   CUSTOMERS(Клиенты)
---номер клиента,компания,номер продовца обслуж. клиента,кредитный лимит клиента
...
---
---  ORDERS(Заказы)
---номер заказа,дата размещения заказа,номер клиента,номер продовца,ID_производителя,ID_товара,кол-во товара в заказе,сумма заказа
