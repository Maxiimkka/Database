...
insert into FACULTY   (FACULTY,   FACULTY_NAME )
            values  ('ИДиП',     'Факультет Информационных дисциплин и прогр'); 
...
insert into PULPIT   (PULPIT,    PULPIT_NAME, FACULTY)
   values  ('СБУАиА', 'Статистики, бухгалтерского учета, анализа и аудита', 'ИЭФ')     
             Insert into PULPIT(PULPIT,PULPIT_NAME,FACULTY)
			 values('ПОиСОИ','не знаю1','ИЭФ'),
			 ('ОВ','не знаю2','ХТИТ'),
			 ('ТНХСиППМ','не знаю3','ТТЛП'),
			 ('ХТЭПиМЭЕ','не знаю4','ЛХФ');
...
insert into GROUPS   (IDGROUP, FACULTY,  PROFESSION, YEAR_FIRST )
         values (1,'ИДиП','1-40 01 02', 2013), --1
